...
def generate_token(kind_name):
    ...
    render_template(f'{kind_name}_impl.templ', ROOT_DIR / 'source' / 'parser' / f'{kind_name}.cpp', context)
...
def generate_syntax():
    ...
    render_template('Syntax_impl.templ', ROOT_DIR / 'source' / 'parser' / 'Syntax.cpp', context)
